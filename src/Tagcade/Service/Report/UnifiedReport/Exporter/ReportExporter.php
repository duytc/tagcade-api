...
class ReportExporter implements ReportExporterInterface
{
    ...
    public function getPartnerAllSitesBySitesReport(PublisherInterface $publisher, AdNetworkInterface $adNetwork, Params $params)
    {
        if ($publisher instanceof SubPublisherInterface) {
            return $this->getResult(
                $this->unifiedReportBuilder->getAllSitesDiscrepancyBySiteForPartnerWithSubPublisher($adNetwork, $publisher, $params),
                $params
            );
        }
    ...
    public function getPartnerAllSitesByAdTagsReport(PublisherInterface $publisher, AdNetworkInterface $adNetwork, Params $params)
    {
        if ($publisher instanceof SubPublisherInterface) {
            return $this->getResult(
                $this->unifiedReportBuilder->getAllSitesDiscrepancyByAdTagForPartnerWithSubPublisher($adNetwork, $publisher, $params),
                $params
            );
        }
    ...
    {
        return $this->getResult(
            $this->unifiedReportBuilder->getSubPublishersDiscrepancyReport($publisher, $params),
            $params
        );
    }
    ...
    {
        return $this->getResult(
            $this->unifiedReportBuilder->getSubPublishersDiscrepancyReportByPartner($adNetwork, $publisher, $params),
            $params
        );
    }
