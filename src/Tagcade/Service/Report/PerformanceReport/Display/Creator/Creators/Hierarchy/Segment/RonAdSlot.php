...
class RonAdSlot extends CreatorAbstract implements RonAdSlotInterface
{
    ...
    public function doCreateReport(RonAdSlotReportType $reportType)
    {
        ...
        $report
            ...
            $rateAmount = $this->billingCalculator->calculateBilledAmountForPublisher($this->getDate(), $ronAdSlot->getLibraryAdSlot()->getPublisher(), AbstractUser::MODULE_DISPLAY, $report->getSlotOpportunities());
