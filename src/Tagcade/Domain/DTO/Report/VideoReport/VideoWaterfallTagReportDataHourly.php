...
class VideoWaterfallTagReportDataHourly extends VideoAbstractReportData implements VideoWaterfallTagReportDataInterface
{
    const KEY_DATE_FORMAT_HOURLY = 'ymdH';
    ...
    protected function getCacheKey($cacheKeyPrefix, $namespace, \DateTime $day)
    {
        ...
        return sprintf($keyFormat, $cacheKeyPrefix, $namespace, $day->format(self::KEY_DATE_FORMAT_HOURLY));
    }
}