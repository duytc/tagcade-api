...
class LibraryExpressionFormType extends AbstractRoleSpecificFormType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder->addEventListener(
            ...
            function (FormEvent $event) {
                ...
                try {
                    ...
                    $this->validateExpressionDescriptor($libraryExpression->getExpressionDescriptor());
        ...
        $builder
            ...
            ->add('expectLibraryAdSlot', 'entity', ['class' => LibraryAdSlotAbstract::class])
    ...
    private function validateExpressionDescriptor(array $expression)
    {
        ...
        if (array_key_exists(self::KEY_GROUP_TYPE, $expression)
            ...
            if (!array_key_exists(self::KEY_EXPRESSION_VAR, $expression)
                ...
                throw new InvalidFormException('"' . self::KEY_EXPRESSION_VAR . '" or "' . self::KEY_EXPRESSION_CMP . '" or "' . self::KEY_EXPRESSION_VAL . '" or "' . self::KEY_EXPRESSION_TYPE . '" can not be empty');
            } else {
    ...
    private function validateVar($var)
    {
        ...
        if (!preg_match('/\${PAGE_URL}|\${USER_AGENT}|\${COUNTRY}|\${SCREEN_WIDTH}|\${SCREEN_HEIGHT}|\${WINDOW_WIDTH}|\${WINDOW_HEIGHT}|^[a-zA-Z_\x7f-\xff][a-zA-Z0-9_\x7f-\xff]*$/', $var)) {
