...
class SiteController extends RestControllerAbstract implements ClassResourceInterface
{
     ...
     * @Rest\View(
     *      serializerGroups={"user.min", "slotlib.summary", "adslot.detail", "displayadslot.summary", "librarydisplayadslot.summary", "librarynativeadslot.summary", "librarydynamicadslot.summary", "nativeadslot.summary", "dynamicadslot.summary"}
     * )
     * @Rest\QueryParam(name="page", requirements="\d+", nullable=true, description="the page to get")
     * @Rest\QueryParam(name="limit", requirements="\d+", nullable=true, description="number of item per page")
     * @Rest\QueryParam(name="searchField", nullable=true, description="field to filter, must match field in Entity")
