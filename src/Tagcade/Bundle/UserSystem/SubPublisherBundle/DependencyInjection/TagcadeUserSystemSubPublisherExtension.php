...
namespace Tagcade\Bundle\UserSystem\SubPublisherBundle\DependencyInjection;
 ...
 */
class TagcadeUserSystemSubPublisherExtension extends Extension
{
    /**
     * {@inheritdoc}
     */
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        /*
            ...
            Will internally get converted to an 'tagcade_user_system_sub_publisher_profile' form-type service definition.
            Never set the template namespace to FOSUserBundle or RollerworksMultiUserBundle as this will create an endless recursion!
        */

        $factory->create('tagcade_user_system_sub_publisher', array(
            array(
                /*
                ...
                'services_prefix' => 'tagcade_user_system_sub_publisher',
                'routes_prefix' => 'tagcade_user_system_sub_publisher',

                'db_driver' => 'orm', // can be either: orm, mongodb, couchdb or custom (Propel is not supported)
                'model_manager_name' => 'default',
                'use_listener' => true,

                'user_class' => 'Tagcade\Bundle\UserSystem\SubPublisherBundle\Entity\User',
                ...
                /*
                'group' => array(
                    'group_class' => 'Tagcade\Bundle\UserSystem\SubPublisherBundle\Entity\Group',
