...
class UnifiedReportExportController extends FOSRestController
{
     ...
     * @return array
     */
    public function getSubPublisherAllPartnersAction($publisherId)
    {
        $publisher = $this->getPublisher($publisherId);

        return $this->getUnifiedReportExporter()->getSubPublisherReport($publisher, $this->getParams());
    }
     ...
     * @return array
     */
    public function getSubPublisherForPartnersAction($publisherId, $partnerId)
    {
        $publisher = $this->getPublisher($publisherId);
        $adNetwork = $this->getAdNetworkHasPartnerWithPublisher($partnerId, $publisher);

        return $this->getUnifiedReportExporter()->getSubPublishersForPartnerReport($publisher, $adNetwork, $this->getParams());
    }
    ...
    public function getPartnerAllSitesByAdTagAction($publisherId, $partnerId)
    {
        ...
        return $this->getUnifiedReportExporter()->getPartnerAllSitesByAdTagsReport($publisher, $partner, $this->getParams());
    }
