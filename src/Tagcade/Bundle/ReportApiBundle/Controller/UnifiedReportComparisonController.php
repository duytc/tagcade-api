 ...
 */
class UnifiedReportComparisonController extends FOSRestController
{
    ...
    public function getPublisherAllPartnersByPartnerAction($publisherId)
    {
        ...
        return $this->getResult(
            $this->getReportBuilder()->getAllPartnersDiscrepancyByPartnerForPublisher($publisher, $this->getParams())
        );
    }
     ...
     * @return array
     */
    public function getSubPublishersReportByPartnerAction($publisherId, $partnerId)
    {
        $publisher = $this->getPublisher($publisherId);
