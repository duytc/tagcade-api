...
class AdTagReportRepository extends AbstractReportRepository implements AdTagReportRepositoryInterface
{
    ...
    public function overrideReport(AdTagReportInterface $report)
    {
        $sql = 'INSERT INTO `report_performance_display_hierarchy_ad_network_ad_tag`
                 ...
                 first_opportunities, verified_impressions, unverified_impressions, blank_impressions, void_impressions, clicks, refreshes, ad_opportunities, network_opportunity_fill_rate
                  ...
                  :firstOpportunities, :verifiedImpressions, :unverifiedImpression, :blankImpressions, :voidImpressions, :clicks, :refreshes, :adOpportunities, :networkOpportunityFillRate
